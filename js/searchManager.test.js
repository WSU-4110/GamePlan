...
describe('SearchManager', () => {
  ...
  describe('_renderResults()', () => {
    ...
    test('should hide no results message when results exist', () => {
      const results = [
        { title: 'Test', engine: 'Unity', description: 'Desc', keywords: [] }
      ];
    ...
    test('should append cards to results area', () => {
      const results = [
        { title: 'Inventory System', engine: 'Unity', description: 'Item management', keywords: [] }
      ];
    ...
    test('should work with mock API strategy', async () => {
      const mockAPIStrategy = {
        fetchData: jest.fn().mockResolvedValue([
          { title: 'API Result', engine: 'Unity', description: 'From API', keywords: [] }
        ])
      };
